...
extension CPU {
    func operand_address(_ mode: AddressingMode) -> UInt16 {
        ...
        case .zeroPage:
            return UInt16(mem_read(programCounter))

        case .zeroPageX:
            let pos = mem_read(programCounter)
        ...
        case .absolute:
            return mem_read_16(programCounter)

        case .absoluteX:
            let pos = mem_read_16(programCounter)
        ...
        case .indirectX:
            let base = mem_read(programCounter)
